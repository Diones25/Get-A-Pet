...
module.exports = class UserController {
    static async register(req, res) {
        ...
        try{
            ...
            //Esse middleware cria um token ao cadastrar um usuário
    ...
    static async login(req, res) {
        ...
        //Verificar se a senha é a mesma que ta cadastrada no banco de dados
        ...
        //Esse middleware cria um token quando o usuário faz o login
